...
function showResults() {
    ...
    if (Uname) {
        quiz.innerHTML = `
            ...
            <button onclick="location.reload()" style="background-color: #f16c43; width: 100%;" class=" btn scrolldrag py-3 px-4 d-md-1  mr-5 hidePrint">Reload</button> <br> <hr >
            <button onclick="navigateAndPrint()" style="background-color: #f16c43; width: 100%;" class=" btn scrolldrag py-3 px-4 d-md-1  mr-5 hidePrint">Print Score</button>            
            <br>
            <br>
            <div id="showMe"></div>
        `;
